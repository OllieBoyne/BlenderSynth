...
with open("docs/index.rst", "w") as f:
    ...
    # Write the toctrees
    write_toctree(f, 'BlenderSynth', ['About BlenderSynth <https://ollieboyne.github.io/BlenderSynth/>', 'getting_started/installation.rst', 'getting_started/troubleshooting.rst'])
