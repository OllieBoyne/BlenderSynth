...
class Overlay:
    ...
    def apply(self, render_result: RenderResult):
        """
        Apply an overlay to a render result.

        :param render_result: RenderResult object containing the render paths."""
    ...
    def run(self, paths_in) -> Path:
        """
        Run an overlay on a set of input images.

        :param paths_in: List of paths to input images.
