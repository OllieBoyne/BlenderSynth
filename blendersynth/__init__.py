...
if BLENDER_IMPORTS:
	...
	execute_jobs, install_module = [IllegalImport(REQUIRES_BLENDER=False) for _ in range(2)]
	...
	# set IllegalImports here to warn users if they access the objects in the wrong python environment
	Mesh, Material, Curve, Empty, render, Compositor, aov, Inputs, DebugInputs, cleanup_temp_files, log_event, world, \
	Light, Camera, annotations, layout, blender_utils, *___ = [IllegalImport() for _ in range(99)]
