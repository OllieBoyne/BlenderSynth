...
comp = bsyn.Compositor()  # create compositor
...
visual = comp.stack_visuals(bounding_box_visual, keypoints_visual, axis_visual)

bsyn.render.set_resolution(512, 512)
bsyn.render.set_cycles_samples(10)

comp.define_output('Image', directory='pose')
comp.define_output(visual, file_name='visual', directory='pose')
...
overlay_kwargs = dict(BBox=bounding_boxes, Keypoints=keypoints,
					  Axes=axes)
